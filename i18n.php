 ...
 */
function __($message, $vars = array())
{
    return \App\System\App::container()->get('i18n')->getTranslator()->translate($message, $vars);
}
 ...
 * @return string           Translated message
 */
function __p($singular, $plural, $number, $vars = array())
{
    return \App\System\App::container()->get('i18n')->getTranslator()->translatePlural($singular, $plural, $number, $vars);
}

function t($message, $vars = array())
{
